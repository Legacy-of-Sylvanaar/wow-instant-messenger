...
WIM.AddLocale("deDE", {
    ...
    ["Hides these messages from the game's chat frame so they appear only in WIM. Per-type and per-channel 'Never Suppress' exceptions on the Conversations pages win. A message is not hidden when no WIM window would show it."] = "Blendet diese Nachrichten im Chatfenster des Spiels aus, sodass sie nur in WIM erscheinen. Die Ausnahmen 'Nie unterdrücken' pro Typ und pro Kanal auf den Seiten unter Unterhaltungen haben Vorrang. Eine Nachricht wird nicht ausgeblendet, wenn kein WIM-Fenster sie anzeigen würde.", -- Google Translate placeholder until native language speaker can confirm locale or suggest corrected translation
