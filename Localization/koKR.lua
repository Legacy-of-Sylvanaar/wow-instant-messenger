...
WIM.AddLocale("koKR", {
    ...
    ["You can group two or many windows together by <Shift-Clicking> a window and dragging it on top of another."] = "<Shift-클릭>으로 창을 선택한 뒤 다른 창 위로 끌어다 놓으면 여러 창을 하나의 탭 그룹으로 묶을 수 있습니다.",
    ...
    ["Demo Window"] = "데모 창",
    ["<Shift-Click> to close window."] = "<Shift-클릭>으로 창을 닫습니다.",
    ["Message Window Hidden"] = "메시지 창 숨김",
    ["WIM's message window has been hidden to WIM's Minimap Icon. If you want to end a conversation, you may do so by <Shift-Clicking> the close button."] = "WIM 메시지 창이 미니맵 아이콘으로 숨겨졌습니다. 대화를 종료하려면 <Shift-클릭>으로 닫기 버튼을 누르세요.",
    ["Default"] = "기본값",
